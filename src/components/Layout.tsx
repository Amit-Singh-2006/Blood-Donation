...
export default function Layout() {
  ...
  const hideNav = location.pathname === '/' || location.pathname === '/register-donor';
          ...
          <div className="flex items-center gap-4">
             {isDonorLayout ? (
               <>
                 ...
                 <button className="flex items-center gap-2 bg-slate-100 p-1 pr-3 rounded-full hover:bg-slate-200 transition-colors">
                    <div className="w-8 h-8 rounded-full bg-[#ee2b2b]/10 flex items-center justify-center text-[#ee2b2b]">
                      <span className="material-symbols-outlined text-sm">person</span>
                    </div>
                    <span className="text-xs font-bold text-slate-700">Alex J.</span>
                 </button>
               </>
             ) : (
